...
import CowMilkImg from "../../Components/Assets/CowMilkImg.jpg";
...
const CowMilkPage = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const stockResponse = await axios.get('https://milkdash.onrender.com/api/stocks/cowmilk');
                setStock(stockResponse.data.stock);
    
                const priceResponse = await axios.get('https://milkdash.onrender.com/api/product-price/cowmilk');
   ...
   const [location, setLocation] = useState(null);
       ...
       const handleBuyNow = async () => {
        ...
        navigate(`/payment?amount=${totalAmount}&name=${user.name}&phone=${user.contactnumber}&email=${user.email}&productname=CowMilk&quantity=${quantity}&deliveryaddress=${address}`);
    };
        ...
        <div className="product-page">
            <div className="product-container">
                <div className="product-image">
                    <img src={CowMilkImg} alt="Cow Milk" />
                </div>

                <div className="product-content">
                    <h1>Cow Milk</h1>
                    <p>Fresh and Pure Cow Milk, Rich in Protein. Perfect for a Healthy Life.</p>
