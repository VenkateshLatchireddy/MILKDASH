...
const BuffaloMilkPage = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const stockResponse = await axios.get('http://localhost:5000/api/stocks/buffalomilk');
                setStock(stockResponse.data.stock);

                const priceResponse = await axios.get('http://localhost:5000/api/product-price/buffalomilk');
    ...
    const handleBuyNow = async () => {
        ...
        navigate(`/payment?amount=${totalAmount}&name=${user.name}&phone=${user.contactnumber}&email=${user.email}&productname=BuffaloMilk&quantity=${quantity}&deliveryaddress=${address}`);
    };
        ...
        <div className="product-page">
            <div className="product-container">
                <div className="product-image">
                    <img src={BuffaloMilkImg} alt="Buffalo Milk" />
                </div>

                <div className="product-content">
                    <h1>Buffalo Milk</h1>
                    <p>Fresh and Pure Buffalo Milk, Rich in Protein. Perfect for a Healthy Life.</p>
...
export default BuffaloMilkPage;
