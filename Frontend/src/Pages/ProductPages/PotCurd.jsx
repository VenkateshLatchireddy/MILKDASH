    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const stockResponse = await axios.get(`${API_BASE_URL}/api/stocks/potcurd`);
                setStock(stockResponse.data.stock);
    
                const priceResponse = await axios.get(`${API_BASE_URL}/api/product-price/potcurd`);
        ...
        <div className='product-page'>
            <div className='product-container'>
                <div className='product-image'>
                    <img src={PotCurdImg} alt='Pot Curd' />
                </div>
