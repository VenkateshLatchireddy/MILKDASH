...
import PaneerImg from '../../Components/Assets/PaneerImg.jpg';
...
const PaneerPage = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const stockResponse = await axios.get(`${API_BASE_URL}/api/stocks/paneer`);
                setStock(stockResponse.data.stock);
    
                const priceResponse = await axios.get(`${API_BASE_URL}/api/product-price/paneer`);
    ...
    const handleBuyNow = async () => {
        ...
        navigate(`/payment?amount=${totalAmount}&name=${user.name}&phone=${user.contactnumber}&email=${user.email}&productname=Paneer&quantity=${quantity}&deliveryaddress=${address}`);
    };
        ...
        <div className='product-page'>
            <div className='product-container'>
                ...
                <div className='product-content'>
                    <h1>Paneer</h1>
                    <p>Freshly made paneer, rich, soft, and packed with flavor. Perfect for any dish, it’s crafted with care to bring you the best quality and taste!</p>
